      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <select
            id="documentType"
            disabled={isFormLoading}
            className={`h-10 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm shadow-sm transition-all duration-200 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-gray-50 ${
              documentErrors?.documentType ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''
            }`}
            value={documentType}
