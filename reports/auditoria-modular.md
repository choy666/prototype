...
-- [x] Revisar accesibilidad en `/components/ui` (ej. ARIA labels)
-- [x] Auditar responsive en páginas públicas (`/app/page.tsx`, `/app/products`)
-- [x] Validar navegación en `/app/layout.tsx` y componentes de navbar/footer
-- [x] Probar componentes reutilizables en `/components` (botones, formularios)
-- [x] Verificar carga de imágenes y optimización (Next.js Image)
-
