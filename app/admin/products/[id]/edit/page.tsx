...
interface Product {
  ...
  shippingAttributes?: Record<string, unknown> | null;
}
...
export default function EditProductPage() {
  ...
  useEffect(() => {
    ...
    const fetchListingTypes = async () => {
      try {
        ...
        if (!isActive) return;
        console.error('Error obteniendo tipos de publicación', error);
  ...
  useEffect(() => {
    if (!form.mlCategoryId || listingTypeOptions.length === 0) {
      return;
    }
  ...
  }, [form.mlCategoryId, form.mlListingTypeId, listingTypeOptions]);
      ...
      <div className='sticky top-0 z-40 bg-dark/95 backdrop-blur supports-[backdrop-filter]:bg-dark/60 border-b border-dark-lighter'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex items-center justify-between h-16'>
            ...
            <div
              className={`flex items-center gap-3 px-4 py-2 rounded-lg border ${getReadinessColor(calculateReadinessScore(form))}`}
            >
          ...
          <div className='lg:col-span-1'>
            <Card className='sticky top-24 bg-dark-lighter border-dark-lighter'>
              ...
              <CardContent className='space-y-2'>
                {getValidations(form, attributes, recommendedAttributes).map(
              ...
              <div className='space-y-1'>
                ...
                {me2Status.loading ? (
                  <p className='text-xs text-dark-text-secondary'>
                    Validando atributos ME2 del producto…
                  </p>
                ) : me2Status.error ? (
                  <p className='text-xs text-red-400'>{me2Status.error}</p>
                ) : (
                  <>
                    {me2Status.canUseME2 ? (
            ...
            <Tabs defaultValue='basic' className='w-full mt-6'>
              <div className='overflow-x-auto pb-2'>
                <TabsList className='grid w-full min-w-max grid-cols-3 bg-dark-lighter border-dark-lighter'>
                  <TabsTrigger
                    value='basic'
                    className='flex items-center gap-2 transition-all duration-200 whitespace-nowrap data-[state=active]:bg-dark data-[state=active]:text-dark-text-primary'
                  >
                  ...
                  <TabsTrigger
                    value='attributes'
                    className='flex items-center gap-2 transition-all duration-200 whitespace-nowrap data-[state=active]:bg-dark data-[state=active]:text-dark-text-primary relative'
                  >
              ...
              >
                <Card className='transition-all duration-300 hover:shadow-lg bg-dark-lighter border-dark-lighter'>
                  <CardHeader>
                    <CardTitle className='text-dark-text-primary'>
                    ...
                    <form onSubmit={handleSubmit} className='space-y-8 pb-24'>
                      ...
                      <div className='space-y-6'>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6'>
                          ...
                          <div>
                            <Label htmlFor='price' className='text-dark-text-primary'>
                              Precio *
                            </Label>
                            <Input
                              id='price'
                          ...
                          <div className='sm:col-span-2 lg:col-span-3'>
                            <Label htmlFor='mlCategoryId' className='text-dark-text-primary'>
                            ...
                            {mlCategories.length === 0 && (
                              <p className='mt-2 text-sm text-amber-400'>
                                No hay categorías oficiales de Mercado Libre configuradas. Ve a la
                                sección Categorías y usa el botón Actualizar desde Mercado Libre
                                antes de editar productos.
                              </p>
                            )}
                          </div>
                        </div>
                      ...
                      <div className='space-y-6'>
                        <div className='border-b border-dark-lighter pb-2'>
                          ...
                          <p className='text-sm text-dark-text-secondary mt-1'>
                            Describe tu producto con detalles: características principales,
                            materiales, beneficios, usos recomendados...
                          </p>
                        </div>

                        <div>
                          <Label htmlFor='description' className='text-dark-text-primary'>
                            Descripción *
                          </Label>
                          <textarea
                            id='description'
                      ...
                      <div className='space-y-6'>
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                          <div>
                            <Label htmlFor='image' className='text-dark-text-primary'>
                              Imagen Principal
                            </Label>
                            <Input
                              id='image'
                            ...
                            {form.image && (
                              <div className='flex items-center gap-3 p-3 border rounded-lg bg-dark-lightest border-dark-lighter mt-2'>
                                ...
                                <div className='flex-1'>
                                  ...
                                  <p className='text-xs text-dark-text-secondary truncate max-w-xs'>
                                    {form.image}
                                  </p>
                                </div>
                                <Button
                      ...
                      <div className='space-y-6'>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6'>
                          <div>
                            <Label htmlFor='mlItemId' className='text-dark-text-primary'>
                              ML Item ID (opcional)
                            </Label>
                            <Input
                              id='mlItemId'
                            ...
                            <p className='mt-1 text-xs text-dark-text-secondary'>
                              Se completa automáticamente al sincronizar con Mercado Libre, pero
                              puedes ajustarlo si ya existe una publicación.
                            </p>
                          </div>

                          <div>
                            <Label htmlFor='shippingMode' className='text-dark-text-primary'>
                              Modo de envío ML
                            </Label>
                            <select
                              id='shippingMode'
              ...
              >
                <Card className='transition-all duration-300 hover:shadow-lg bg-dark-lighter border-dark-lighter'>
                  <CardHeader>
                    ...
                    <p className='text-sm text-dark-text-secondary'>
                      Define atributos adicionales como talla, color, material, etc. Estos atributos
                      pueden ser usados para mapear variaciones en Mercado Libre.
                    </p>
                  </CardHeader>
                  <CardContent>
                    <MLAttributesGuide
                        ...
                        onClick={async () => {
                          try {
                            ...
                            if (!response.ok) {
                              const error = await response.json();
                              throw new Error(
                                error.error || 'No se pudieron guardar los atributos'
                              );
                            }
